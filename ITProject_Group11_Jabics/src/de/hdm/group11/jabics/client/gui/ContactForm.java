...
//	Label userInformationLabel = new Label("User: ");
	...
	Label contactStreetLabel = new Label("StraÃŸe: ");
	Label contactZipLabel = new Label("Postleitzahl: ");
	Label contactOrtLabel = new Label("Ort: ");
	
	/**
	 * Im nÃ¤chsten Schritt werden die Labels fÃ¼r die konkreten EigenschaftsausprÃ¤gungen instanziiert. 
	 */
	...
	private class DeleteClickHandler implements ClickHandler {
		...
		public void onClick(ClickEvent event) {
			...
			if(contactToDisplay == null) {
				Window.alert("Kein Kontakt ausgewÃ¤hlt");
			}else {
