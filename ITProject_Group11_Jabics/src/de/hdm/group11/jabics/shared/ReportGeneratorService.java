 ...
 *  In Jabics gibt es drei verschiedene Reportarten, welche ausgegeben werden k�nnen. 
 ...
 *  Reports erstellt werden k�nnen.
 *  
 *  @author Kurrle
 *  @author Anders
 */ 
...
public interface ReportGeneratorService extends RemoteService {
	 ...
	 * 
	 * @param reports Enth�lt ContactReport, die gefiltert werden sollen.
	 * @param p enth�lt Filterkriteren wie int, float oder Contact.
